...
export default function Overlay() {
							...
							return (
								<div key={player.id} style={{width:"60px", textAlign:"center"}}>
									<div style={{paddingLeft:"5px"}}>
										...
										{/* <p>Imp: {player.isImpostor}</p>
										<p>Vnt: {player.inVent}</p> */}
									</div>
									{name}
									{/* <p>X: {player.x.toFixed(2)}</p>
									<p>Y: {player.y.toFixed(2)}</p> */}
								</div>
							);
						})
					}
	...
	var mapOverlay = <MapOverlay players={playerList} gamestate={gameState} />
